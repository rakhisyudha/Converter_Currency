...
async function getExchangeRate() {
    ...
    try {
        const response = await fetch(`https://v6.exchangerate-api.com/v6/d9300e0672b47d992c6cd693/latest/${fromCur.value}`);
        const result = await response.json();
        const exchangeRate = result.conversion_rates[toCur.value];
        const totalExRate = (amountVal * exchangeRate).toLocaleString();
